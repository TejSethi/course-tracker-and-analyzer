...
class CourseFormView(Frame):
    def __init__(self, parent, controller):
        ...
        title_label = Label(self, text="Add Course", font=("Arial", 24), anchor="w", justify="left")
        ...
        self.semester_entry = Combobox(form_frame, values=["Fall", "Winter", "Summer", "Full-Year"], state="readonly")
